...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="d-flex flex-column min-vh-100">
        <nav class="navbar nav-expand-md navbar-expand-lg nav-expand-xl bg-white sticky-top">
            @include('partials.layouts.main.navbar')
        </nav>
        ...
        <footer id="footer" class="mt-5 py-4 text-center bg-white w-100 container-fluid text-start" >
            @include('partials.layouts.main.footer')
        </footer>
